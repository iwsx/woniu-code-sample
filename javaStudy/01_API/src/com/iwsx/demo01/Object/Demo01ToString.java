package com.iwsx.demo01.Object;
...
public class Demo01ToString{
    public static void main(String[] args) {
        ...
        String s = p.toString();
        System.out.println(s);//com.iwsx.demo01.Object.Person@75412c2f | abc | Person{name=张三 ,age=18}

        //直接打印对象的名字,其实就是调用对象的toString  p=p.toString();
        System.out.println(p);//com.iwsx.demo01.Object.Person@5f150435 | abc | Person{name=张三 ,age=18}
        ...
        System.out.println(array); //[I@47fd17e3 没有重写toString
    }
}
